...
\textcolor{red}{Aquí meter una foto de rastreo y comentar los cambios realizados y que se observa, y si aparece algún problema comentarlo también.}

\noindent\includegraphics[width=6cm]{example-image}

\textcolor{red}{Aquí dejar claro que los resultados después de todas las pruebas realizadas en el seguimiento de objetos y personas se podrá visualizar con mayor detalle en la sección XXX}
